...
namespace WinTail
{
    ...
    public class TailActor : ReceiveActor
    {
        ...
        public TailActor(ActorRef reporterActor, string filePath)
        {
            ...
            Receive<FileError>(msg => _reporterActor.Tell(string.Format("Tail error: {0}", msg.Reason)));
            Receive<InitialRead>(msg => _reporterActor.Tell(msg.Text));
        }
